...
import { cacheManagementSection } from "@dashboard/cacheManagement/urls";
...
const CacheManagementSection = lazy(() => import("./cacheManagement"));
            ...
            >
              <Suspense fallback={<LoginLoading />}>
                <Switch>
                  ...
                  <SectionRoute
                    permissions={[PermissionEnum.MANAGE_SETTINGS]}
                    path={cacheManagementSection}
                    component={CacheManagementSection}
                  />
